...
cp crewtimer3-video-white.svg crewtimer.svg
echo "see https://www.aconvert.com/image/png-to-icns/#google_vignette to build icns file or ask chatgpt how using mac command line"
